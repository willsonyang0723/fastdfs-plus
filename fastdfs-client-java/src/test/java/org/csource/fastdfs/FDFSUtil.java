   ...
   /* static {
    ...
    public static void main(String[] args) {
    	...
    	try {
        	...
        	String path = FDFSUtil.uploadFile(FileUtils.readFileToByteArray(new File("D:/1.pdf")), "pdf");
        	System.out.println(path);
        	long b = System.currentTimeMillis();
        	System.out.println("开始发送请求："+DateFormatUtils.format(new Date(), "HH:mm:ss"));
        	String data=HttpUrlPost.sendGet(path, "");
        	long a = System.currentTimeMillis();
        	System.out.println("发送请求结束："+DateFormatUtils.format(new Date(), "HH:mm:ss"));
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//            String str=FDFSUtil.uploadString(uploads);
