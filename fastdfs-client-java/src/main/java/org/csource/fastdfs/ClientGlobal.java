...
public class ClientGlobal {
  ...
  public static final String PROP_KEY_MEMCACHE_SERVERS="memcache_server";
  ...
  public static String g_memcache_server="10.0.2.230:12121";//memcache 默认地址
  ...
  public static void init(String conf_filename) throws IOException, MyException {
    ...
    System.out.println(iniReader.getStrValue(PROP_KEY_MEMCACHE_SERVERS));
    if(iniReader.getStrValue(PROP_KEY_MEMCACHE_SERVERS)!=null && iniReader.getStrValue(PROP_KEY_MEMCACHE_SERVERS).length()>0)
    	g_memcache_server = iniReader.getStrValue(PROP_KEY_MEMCACHE_SERVERS);//memcache赋值
  }
  ...
  public static void initByProperties(Properties props) throws IOException, MyException {
    ...
    String memcacheConf = props.getProperty(PROP_KEY_MEMCACHE_SERVERS);
