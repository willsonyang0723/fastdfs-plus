...
import org.csource.common.MemcacheUtil;
...
public class StorageClient {
  ...
  public String[] upload_file(byte[] file_buff, String file_ext_name,
                              NameValuePair[] meta_list) throws IOException, MyException {
    final String group_name = null;
    String[] url = this.upload_file(group_name, file_buff, 0, file_buff.length, file_ext_name, meta_list);
    /****开始存储缓存*****/
    String mkey = "http://"+storageServer.inetSockAddr.getHostName()+"/"+url[0]+"/"+url[1];
    MemcacheUtil.set(mkey, 15, file_buff);
    /****存储缓存end*****/
